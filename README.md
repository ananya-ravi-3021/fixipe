# fixipe
Scans and fixes recipes - the Orbital Project of team bananix </br>**Update: fixipeBot is live! Go check it out at [here.](https://t.me/fixipeBot)**</br>
...
- Key Components: Swift UI, database handling through Firebase, and text recognition using Swift's Vision framework.
- Text recognition  is used to identify keywords found in photos taken and alter them accordingly.
